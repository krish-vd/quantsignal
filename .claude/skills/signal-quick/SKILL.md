---
description: Quickly compute one or more factor values for a small list of tickers right now (no full backtest, no historical IC/IR). Use for fast sanity checks like current momentum/ROE for a handful of stocks.
---
